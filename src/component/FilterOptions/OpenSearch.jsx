...
export default function OpenSearch({dispatchFilter}) {
    ...
    return (
        <div>
            ...
            <div className="relative">
                ...
                <input onChange={handleChange} type="srearch" placeholder="Search" className="block p-2 pl-7 w-48 rounded outline-none bg-gray-100 drop-shadow-md" />
            </div>
        </div>
    )
}