...
export function OpenSearch({ dispatchFilter, className, state }) {
    ...
    return (
        <div className={className}>
            <div className="block w-full pl-2 text-left capitalize font-semibold text-gray-a-900">Search</div>
            <div className="relative lg:w-40 w-full">
                ...
                <input onChange={handleChange} ref={inputRef} type="srearch" placeholder=""
                    className="block p-2 pl-7 w-full rounded outline-none shadow-gray-200/60 shadow-lg" />
            </div>
        </div>
    )
}